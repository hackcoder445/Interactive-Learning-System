			<form id="login_form1" class="form-signin" method="post">
						...
						<input type="text" class="input-block-level" id="username" name="username" placeholder="Matric Number/ID Number" required>
						...
						jQuery("#login_form1").submit(function(e){
								...
								$.ajax({
									...
									$.jGrowl("Welcome to FPB E-Learning System", { header: 'Access Granted' });
									var delay = 1000;
									...
									{
									$.jGrowl("Please Check your Matric Number/ID No and Password", { header: 'Login Failed' });
									}
									}
								});
								return false;
			...
			<hr>
				...
				<div class="pull-right">
					<button data-placement="top" title="Sign In as Lecturer" id="signin_teacher" onclick="window.location='signup_teacher.php'" name="login" class="btn btn-info" type="submit">I`m a Lecturer</button>
				</div>
			</div>
														<script type="text/javascript">
														$(document).ready(function(){
