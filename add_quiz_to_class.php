                                ...
                                <div class="span12">
									...
									<a href="teacher_quiz.php" class="btn btn-info"><i class="icon-arrow-left"></i> Back</a>
										...
										<div class="control-group">
											<label class="control-label" for="inputEmail">Examination</label>
											<div class="controls">
											<select name="quiz_id">
											<option></option>
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword">Examination Time (in minutes)</label>
											<div class="controls">
											<input type="text" class="span3" name="time" id="inputPassword" placeholder="Examination Time" required>
											</div>
										</div>
					...
					<?php } ?>
										...
										if (isset($_POST['save'])){
											...
											$id=$_POST['selector'];
													...
													$name_notification  = 'Add Practice Examination file';
